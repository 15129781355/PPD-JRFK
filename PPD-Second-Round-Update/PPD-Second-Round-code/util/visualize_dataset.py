...
train = pd.read_csv('../PPD-Second-Round-Data/first round train data/PPD_Training_Master_GBK_3_1_Training_Set.csv',encoding='gb18030')
...
test = pd.read_csv('../data/test/Kesci_Master_9w_gbk_2.csv',encoding='gb18030')
