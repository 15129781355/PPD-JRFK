...
public class CombineFeature {
	public static void main(String[] args) throws Exception {
		Instances train = DataSource.read("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\train.arff");
		train.setClassIndex(train.numAttributes()-1);
		
		String in = "G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\train_x.csv";
//		 String y="G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\train_y.csv";
		String out = "G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\test_x_1300.csv";
...
//		gen_test();
	...
	public static void gen_test() throws Exception {
		BufferedReader br = Util.readFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\test_x_1w.csv");
		String line = "";
		ArrayList<String> list = new ArrayList<>();
		while ((line = br.readLine()) != null) {
			list.add(line);
		}
		br = Util.readFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\train_x_comb.csv");
		line = br.readLine();
		PrintWriter pt = Util.writeFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\test_x_comb.csv");
	...
	public static void muti_feature(String in, String out) throws Exception {
		...
		pt.println(gen_head());// ̀í¼Ó̀ØƠ÷Ăû
		...
		br = Util.readFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\test_x_comb_feature_score.csv");
		...
		br = Util.readFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\train_y.csv");
		br.readLine();
	...
	public static void muti_feature_calc(String in, String out) throws Exception {
		...
		br = Util.readFile("G:\\±ÈÈü\\Î¢¶î½è¿îÓĂ»§ÈËÆ·Ô¤²â\\features_type.csv");
		// Èç¹ûÊÇÊưÖµ̀ØƠ÷£¬±£´æÏÂ±ê
		int index = 0;
		ArrayList<Integer> ind = new ArrayList<>();
		while ((line = br.readLine()) != null) {
